...
if (isset($_POST['submit'])) {
    ...
    $hashed_pass = generateRandomString(5);
    ...
    $sql = "INSERT INTO `users`(`username`, `password`, `perm`, `admin`, `reset`) VALUES ('$username', '$hashed_pass', '$perm', '$admin', 1)";

    $result = mysqli_query($conn, $sql);

    if ($result) {
        header("Location: ../index.php?msg=$perm '$username' créé avec succès");
        LogAction($_SESSION['username'] . " a ajouter l'utilisateur $username avec le role $perm - Mot de passe temporaire: $temp_pass : $hashed_pass");
    } else {
    ...
    <div class="container">
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;">
                ...
                <div class="mb-3">
                    <label class="form-label">Mot de passe temporaire: <p class="fw-bold">A Verifier dans les Logs</p></label>
                </div>
